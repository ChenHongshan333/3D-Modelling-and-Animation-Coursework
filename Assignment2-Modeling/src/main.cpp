...
void display(void)
{
	...
	float mat_specular_low[]  = { 0.3f, 0.3f, 0.3f, 1.0f };
	float mat_specular_high[] = { 1.0f, 1.0f, 1.0f, 1.0f };
	float shininess = m_Highlight ? 128.0f : 20.0f;
	glMaterialfv(GL_FRONT, GL_AMBIENT, mat_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, m_Highlight ? mat_specular_high : mat_specular_low);
